...
EAStep vivado -log sa_engine_ip_v1_0_bfm_1_sa_engine_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sa_engine_ip_v1_0_bfm_1_sa_engine_ip_0_0.tcl
