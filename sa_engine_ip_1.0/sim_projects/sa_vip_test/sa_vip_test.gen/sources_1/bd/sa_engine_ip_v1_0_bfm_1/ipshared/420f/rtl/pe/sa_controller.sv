...
module sa_controller (
  ...
  // Result Matrix 8*8
  (* mark_debug = "true" *) reg [18:0] MAT_C0[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C1[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C2[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C3[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C4[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C5[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C6[0:7];
  (* mark_debug = "true" *) reg [18:0] MAT_C7[0:7];
