...
REM
REM Generated by Vivado on Fri Nov 07 22:14:25 +0900 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_tile_loader_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_tile_loader_vlog.prj -log xvlog.log
