...
HD_PWD='C:/Users/sudea/capstone_design_final/capstone_design_final.runs/design_1_sa_engine_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sa_engine_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sa_engine_ip_0_0.tcl
