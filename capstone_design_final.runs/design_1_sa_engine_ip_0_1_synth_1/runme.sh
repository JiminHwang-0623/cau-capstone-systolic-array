...
HD_PWD='C:/Users/User/Desktop/git/cau-capstone/capstone_design_final.runs/design_1_sa_engine_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_sa_engine_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_sa_engine_ip_0_1.tcl
